      ...
      <Container className="px-4 max-w-7xl mx-auto space-y-6">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border-b border-neutral-200/60 dark:border-border-custom/50 pb-5">
          <div>
            ...
            <p className="text-sm text-neutral-500 dark:text-muted-foreground font-medium mt-0.5">
              {lang === "BN"
                ? "শিক্ষার্থীদের প্রোফাইল, রোল এবং ক্লাসভিত্তিক ডাটাবেজ।"
                : "Manage profiles, class rosters, rolls, and institutional records."}
            </p>
          </div>
          ...
          <button className="w-full sm:w-auto h-11 px-5 rounded-xl bg-primary text-white font-bold text-xs flex items-center justify-center gap-2 shadow-xs hover:brightness-105 transition-all">
            ...
            <span>
              {lang === "BN" ? "নতুন শিক্ষার্থী যুক্ত করুন" : "Add New Student"}
            </span>
          </button>
        </div>
        ...
        <div className="grid grid-cols-3 sm:grid-cols-2 lg:grid-cols-3 gap-2 sm:gap-6">
          {stats.map((item, idx) => {
            ...
            return (
              <div
                key={idx}
                className={`bg-white dark:bg-card border rounded-2xl p-2 sm:p-5 flex flex-col sm:flex-row items-center gap-4 text-center sm:text-left ${item.color} `}
              >
          ...
          <div className="w-full md:w-auto flex items-center gap-2 self-stretch md:self-auto">
            <div className="relative w-full md:w-48">
              <select
                ...
                className="w-full h-11 px-4 bg-neutral-50 dark:bg-neutral-900/50 border border-neutral-200/60 dark:border-border-custom rounded-xl text-sm font-bold text-neutral-600 dark:text-muted-foreground outline-none appearance-none cursor-pointer"
              >
                <option value="all">
        ...
        {filteredStudents.length > 0 ? (
          ...
          <div className="bg-white dark:bg-card border border-dashed border-neutral-200 dark:border-border-custom/80 rounded-2xl p-12 text-center">
            ...
            <h3 className="text-sm font-bold text-neutral-700 dark:text-neutral-300">
              {lang === "BN"
                ? "কোনো শিক্ষার্থীর রেকর্ড মেলেনি"
                : "No Student Records Found"}
            </h3>
            <p className="text-xs text-neutral-400 mt-1 max-w-xs mx-auto">
              {lang === "BN"
                ? "অনুগ্রহ করে অন্য কোনো নাম, আইডি অথবা ক্লাস ফিল্টার সিলেক্ট করে ট্রাই করুন।"
