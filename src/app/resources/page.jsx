...
import { FiBookmark, FiDownload, FiFile, FiFolder, FiGrid, FiInfo, FiList, FiSearch, FiSliders } from "react-icons/fi";
...
function ResourcesContent() {
  ...
  const heroData = {
    ...
    title: {
      en: {
        first: "Centralized Knowledge",
        second: "Base For Your",
        highlight: "Institution",
      },
      bn: {
        first: "আপনার প্রতিষ্ঠানের জন্য",
        highlight: "সব জ্ঞান ও রিসোর্স",
        second: "এক কেন্দ্রীয় হাবে।",
      },
    },
    description: {
      en: "Instantly download official curriculum, administrative frameworks, and high-performance assets curated for modern Islamic setups.",
      bn: "আধুনিক ইসলামী প্রতিষ্ঠানের জন্য তৈরি অফিসিয়াল কারিকুলাম, প্রশাসনিক ফ্রেমওয়ার্ক এবং হাই-পারফরম্যান্স ফাইল এক জায়গায় ডাউনলোড করুন।",
    },
    videoUrl: "https://www.youtube.com/embed/AjeBOZXOrgs",
  };
  ...
  const masterResources = useMemo(() => [
    {
      ...
      size: "2.4 MB",
      downloads: "142",
      title: { en: "Arabic Language Syllabus v2", bn: "আরবি ভাষা পাঠ্যক্রম ২য় সংস্করণ" },
      desc: { en: "Comprehensive middle-school Quranic grammar guidelines.", bn: "মিডল স্কুলের জন্য প্রণীত কুরআনিক ব্যাকরণ গাইডলাইন।" }
    },
    {
      id: "res-2",
      ...
      size: "1.1 MB",
      downloads: "98",
      title: { en: "Staff Ethics & Conduct Rules", bn: "শিক্ষক ও কর্মকর্তাদের আচরণবিধি" },
      desc: { en: "Official code of conduct adhering to global Islamic values.", bn: "ইসলামী নৈতিকতা ও নিয়মানুবর্তিতার অফিসিয়াল গাইডবুক টেমপ্লেট।" }
    },
    {
      id: "res-3",
      category: "assets",
      ...
      size: "15.0 MB",
      downloads: "310",
      title: { en: "Branding Kit & Vector Logos", bn: "প্রাতিষ্ঠানিক ব্র্যান্ডিং কিট ও লোগো" },
      desc: { en: "High-res logo variations, official fonts, and letterheads.", bn: "হাই-রেজোলিউশন লোগো ভেরিয়েন্ট, লেটারহেড এবং প্রয়োজনীয় ফন্ট ফাইল।" }
    },
    {
      id: "res-4",
      category: "academic",
      ...
      size: "4.8 MB",
      downloads: "215",
      title: { en: "Islamic History Core Framework", bn: "ইসলামের ইতিহাস মূল ফ্রেমওয়ার্ক" },
      desc: { en: "Secondary level detailed historical analysis blueprint.", bn: "মাধ্যমিক স্তরের জন্য ইসলামের ইতিহাসের বিশেষ ব্লুপ্রিন্ট।" }
    },
    {
      id: "res-5",
      category: "guides",
      ...
      size: "850 KB",
      downloads: "74",
      title: { en: "Admission Policy Master-draft", bn: "ভর্তি পলিসি ও নিয়মাবলী খসড়া" },
      desc: { en: "Step by step automation guide for new registrations.", bn: "নতুন সেশনে ডিজিটাল এডমিশন প্রসেস হ্যান্ডেল করার গাইডলাইন।" }
    }
  ], []);
  ...
  const filteredResources = useMemo(() => {
    return masterResources.filter((item) => {
      ...
      const textToSearch = `${item.title[lang === "BN" ? "bn" : "en"]} ${item.desc[lang === "BN" ? "bn" : "en"]}`.toLowerCase();
      const matchesSearch = textToSearch.includes(searchQuery.toLowerCase());
      
      return matchesCategory && matchesType && matchesSearch;
    });
  }, [activeCategory, fileTypeFilter, searchQuery, masterResources, lang]);
          ...
          <aside className="lg:col-span-1   border border-neutral-200/60 dark:border-neutral-800/60 rounded-2xl p-3 xl:p-6 shadow-xs lg:sticky top-20">
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="flex flex-col gap-1">
                  {[
                    ...
                    { id: "assets", en: "Media & Assets", bn: "মিডিয়া ও অ্যাসেটস" },
                  ].map((cat) => (
                    <button
                      key={cat.id}
                      onClick={() => setActiveCategory(cat.id)}
                      className={`w-full text-left px-4 py-2.5 rounded-xl text-xs md:text-sm font-semibold transition-all flex items-center justify-between cursor-pointer ${
                    ...
                    >
                      <span className="flex items-center gap-2.5">
                        <FiFolder className={`w-4 h-4 ${activeCategory === cat.id ? "text-primary" : "text-neutral-400"}`} />
              ...
              <div className="pt-5 border-t border-neutral-100 dark:border-neutral-900">
                <label className="text-xs font-bold text-neutral-400 dark:text-neutral-500 block mb-2 uppercase">
                  {lang === "BN" ? "ফাইল ফরম্যাট" : "File Extension"}
                </label>
          ...
          <main className="lg:col-span-3 space-y-6">
            ...
            <div className="bg-background border border-neutral-200/60 dark:border-neutral-800/60 rounded-2xl p-3 flex flex-col sm:flex-row gap-3 justify-between items-center shadow-xs">
              <div className="relative w-full sm:max-w-md">
                ...
                <input
                  ...
                  placeholder={lang === "BN" ? "ফাইল বা টাইটেল দিয়ে সার্চ করুন..." : "Search by file title or keyword..."}
                />
              </div>
            ...
            {filteredResources.length > 0 ? (
              <div className={viewMode === "grid" ? "grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6" : "space-y-3"}>
                {filteredResources.map((resource) => (
                  ...
                  >
                    <div className={viewMode === "list" ? "flex items-start gap-4 grow" : ""}>
                      {viewMode === "list" && (
                      ...
                      <div>
                        ...
                        <h4 className="text-base font-bold text-neutral-900 dark:text-white mb-1 group-hover:text-primary transition-colors">
                          {lang === "BN" ? resource.title.bn : resource.title.en}
                        </h4>
                        <p className="text-xs text-neutral-500 dark:text-neutral-400 font-medium leading-relaxed max-w-xl">
                          {lang === "BN" ? resource.desc.bn : resource.desc.en}
                        </p>
                      </div>
                    </div>

                    <div className={`flex items-center gap-2 ${viewMode === "grid" ? "mt-6 pt-4 border-t border-neutral-100 dark:border-neutral-900/60 w-full justify-between" : "shrink-0 w-full sm:w-auto justify-end"}`}>
              ...
              <div className="bg-white dark:bg-[#111917] rounded-2xl p-16 text-center border border-dashed border-neutral-200 dark:border-neutral-800">
                ...
                <h5 className="text-sm font-bold text-neutral-700 dark:text-neutral-300">
                  {lang === "BN" ? "কোনো ফাইল খুঁজে পাওয়া যায়নি" : "No Assets Match Your Filter"}
                </h5>
                <p className="text-xs text-neutral-400 mt-1">
                  {lang === "BN" ? "অনুগ্রহ করে অন্য কোনো ক্যাটাগরি বা কিওয়ার্ড দিয়ে চেষ্টা করুন।" : "Try clearing your text filters or selecting 'All Materials'."}
                </p>
              </div>
            )}
            ...
            <div className="bg-primary  rounded-2xl p-6 text-white flex flex-col md:flex-row items-center justify-between gap-6 shadow-sm">
              <div className="flex items-center gap-4 text-left">
                ...
                <div>
                  <h5 className="text-sm md:text-base font-extrabold">
                    {lang === "BN" ? "নতুন রিসোর্স কন্ট্রিবিউট করতে চান?" : "Want to share institutional assets?"}
                  </h5>
                  <p className="text-xs text-white/70 mt-0.5 font-medium">
                    {lang === "BN" ? "আপনার তৈরি গাইডলাইন আপলোড করে অন্যান্য মাদরাসার আধুনিকায়নে অংশ নিন।" : "Help other Islamic educational frameworks grow by uploading validated files."}
                  </p>
                </div>
              </div>
              <button className="bg-white text-neutral-900 dark:bg-primary dark:text-white px-5 h-10 rounded-xl text-xs font-bold shadow-sm hover:scale-[1.02] transition-all whitespace-nowrap cursor-pointer">
                {lang === "BN" ? "আপলোড পোর্টাল" : "Upload Guidelines"}
              </button>
            </div>
